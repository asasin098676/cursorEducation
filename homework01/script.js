...
console.log("округленна сума: " + Math.round(los));

//Виведіть суму товарів округлену до сотень. (Наприклад якщо вийшло 260, то виведіть
//300)
console.log(
  "сума округлена до сотень: " +
    (Math.round(firstValue) + Math.round(secondValue) + Math.round(thirdValue))
);
...
//грн.
console.log("суму решти: " + (500 - sumValue));

//Виведіть середнє значення цін, округлене до другого знаку після коми

console.log(
  "округлене до другого знаку після коми: " + firstValue.toFixed(2),
  secondValue.toFixed(2),
  thirdValue.toFixed(2)
);

//Створіть змінну, в якої збережіть випадкову знижку (використовуйте
//функцію Math.random).
const randomSale = parseInt(Math.random() * 100);
console.log("random sale = " + randomSale + "%");

//Зробіть клієнту випадкову знижку та виведіть суму до оплати округлену до 2 знаків
//після коми.
const saleCash = (sumValue - (randomSale / 100) * sumValue).toFixed(2);
console.log("сума зі знижкою: " + saleCash);

//Виведіть чистий прибуток, якщо клієнт заплатив зі знижкою та собівартість товарів
//рівно в два рази нижче їх ціни?
const interest = (randomSale / 100) * Math.floor(sumValue);
